/*
 * AI Explorer Academy — cards-en.js
 * English edition of the Explorer Card library (29 cards, editorial version).
 * Core philosophy in every card: AI is the starting point, not the end point — the child stays in charge.
 ...
 * Order: Ontdekken → Samenwerken → Controleren → Verbeteren → Regie Voeren, by rising level.
 */
window.CARDS_EN = [
  {
    "id": "ontdekken-01",
