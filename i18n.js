...
(function () {
  ...
  const UI = {
    ...
    heroTitlePost: { nl: '!', en: '!' },
    heroSub: {
      nl: 'Ga op avontuur met AI. Jij stelt de vragen, jij maakt de keuzes — de AI helpt alleen mee. <strong>Jij houdt de regie.</strong>',
      en: 'Go on an adventure with AI. You ask the questions, you make the choices — the AI only helps. <strong>You stay in charge.</strong>',
    },
    ...
    myPassport: { nl: '🎖️ Mijn Explorer Paspoort', en: '🎖️ My Explorer Passport' },
    adultStrip: {
    ...
    regieLine: { nl: '🧭 Onthoud: de AI hielp mee, maar <strong>jij</strong> hield de regie.', en: '🧭 Remember: the AI helped, but <strong>you</strong> stayed in charge.' },
    ...
    myPassportShort: { nl: '🎖️ Mijn paspoort', en: '🎖️ My passport' },
    prev: { nl: '‹ Vorige', en: '‹ Previous' },
    next: { nl: 'Volgende ›', en: 'Next ›' },
    imDone: { nl: 'Ik ben klaar! ✓', en: "I'm done! ✓" },

    // Paspoort
    passportTitle: { nl: '🎖️ Mijn Explorer Paspoort', en: '🎖️ My Explorer Passport' },
    ...
    yes: { nl: 'Ja', en: 'Yes' },
    no: { nl: 'Nee', en: 'No' },
    resetBtn: { nl: '🗑️ Voortgang op dit apparaat wissen', en: '🗑️ Clear progress on this device' },
