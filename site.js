...
(function () {
  ...
  var EN = {
    ...
    zOmslag: '<strong>Not banning, not letting go: discovering together, with structure.</strong> You do not need to be an AI expert. Every adventure guides you and your child step by step: your child learns what AI <strong>is</strong> and is not, what it <strong>can</strong> and cannot do, what bias is — and how to catch it yourself. That is how AI becomes an ally of their own thinking. Built on the current state of the science, not on the hype.',
    ...
    oWatT: 'What the research tells us — in numbers',
    oW1t: 'Free chatbot access harms learning',
    oW1: 'In an RCT with ±1,000 students (Bastani et al., PNAS 2025), free GPT-4 access led to 17% lower exam scores without AI. The same AI with guardrails — hints instead of answers — gave <strong>+127% practice gains with no exam harm</strong>. The difference is not the AI, but the design.',
    oW2t: 'Good design doubles learning gains',
    oW2: 'An AI tutor built on learning principles (stepwise, withholding the solution) delivered 2× the learning gains of an active-learning class (Kestin et al., Harvard RCT, 2025). The OECD (2026) confirms: no pedagogical framing, no real learning gains. Every adventure with us is that framing.',
    oW3t: 'They are already using it — even the youngest',
    oW3: 'About 1 in 4 children aged 8–12 already uses generative AI (Alan Turing Institute, 2025); 72% of teens have chatted with AI companions (Common Sense Media, 2025). So the question is not whether your child will meet AI — but whether they will have learned to look at it critically first.',
    oW4t: 'Companion chatbots fail the vulnerable',
    oW4: 'Companion chatbots responded adequately to simulated teen crises only 22% of the time (JAMA Network Open, 2025); UNESCO advises guidance for young users. That is why, with us, a child never chats unsupervised — a grown-up is always involved, within a structured assignment.',
    oMeta: 'We maintain our own literature review covering 65+ studies and institutional reports (UNICEF, UNESCO, OECD, APA) on AI and the developing child. Its central thread: <strong>the question is not whether children use AI to learn, but which interaction design during learning is wise.</strong> Frictionless answer machines harm learning; guided, structured assignments strengthen it. Every one of our 54 adventures is designed on exactly that principle. <a href="metareview.html"><strong>Read the full literature review →</strong></a>',
    mrTitle: 'Literature review: AI and the developing child',
    mrSub: '65+ peer-reviewed studies, meta-analyses and institutional reports on brain development, education, learning outcomes and behaviour — synthesised in one honest overview.',
    mrIntro: '<strong>Why we maintain this:</strong> our programme is designed on the current state of the science — and it moves fast. This literature review (in English, like the source literature) underpins our design choices: no chatbot, guided assignments, and the child\'s own thinking as the end point. The central thread: <strong>it is not whether children use AI that determines the effect, but the interaction design during learning.</strong>',
    mrDisclaimer: '<strong>Accountability:</strong> compiled in July 2026 by The Neuronauts. This overview synthesises peer-reviewed studies, meta-analyses, systematic reviews and institutional reports; the overview itself is not a peer-reviewed publication. All citations were verified against the original publications; preprints and working papers are labelled as such.',
    mrTerug: 'Back to the evidence page',
    mrKernT: 'Key facts at a glance',
    mrK1: '<strong>−17% / +127%</strong> — free chatbot access harmed exam scores; the same AI with hints-instead-of-answers gave record practice gains without harm (Bastani et al., PNAS 2025, RCT ±1,000 students).',
    mrK2: '<strong>2× learning gains</strong> — a pedagogically designed AI tutor beat active-learning classes (Kestin et al., Scientific Reports 2025, Harvard RCT).',
    mrK3: '<strong>72% of teens</strong> have used AI companions; <strong>1 in 3</strong> has chosen AI over a human for a serious conversation (Common Sense Media, 2025). <strong>1 in 4 children aged 8–12</strong> already uses generative AI (Alan Turing Institute, 2025).',
    mrK4: '<strong>22%</strong> — how often companion chatbots responded adequately to simulated teen crises; general assistants: 83% (Brewster et al., JAMA Network Open 2025).',
    mrK5: '<strong>0 neuro studies in children</strong> — no brain research on generative AI in children exists yet; panic about brain damage is unfounded, precaution is not (APA, UNICEF, WHO).',
    mrK6: '<strong>Age 13</strong> — UNESCO\'s minimum for independent generative AI use; younger only with supervision.',
    mrFrame: '<strong>The central thread: not banning, not letting go — discovering together, with structure.</strong> Panic is unwarranted (no evidence of brain damage), naivety too (answer machines harm learning; companions fail in crises). The nuanced middle is where the science points — and where this programme is built.',
    footStudie: 'Our literature review',
